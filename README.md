...
多账号获客卡住的地方通常是三个：号和号之间词组重叠投放互相竞价、内容没有分工发着发着就重了、AI 写出来没有真情实感。
...
| feishu-cli | Obsidian 写好，一行命令变飞书云文档 | 开源 | riba2534 |
| 马斯克时间管理 | 五连问砍掉不该存在的事，多号提效 | 开源 | alchaincyf |
| 归因分析（原 ab-test） | 两版选哪个，给决策依据不给感觉 | 开源 | phuryn/pm-skills |
...
| 写作分身（Aria2ever） | 见字如面的写作 Skill | 🔓试用版开源 | Aria |
...
`xhs-content-writing` 包含完整的方法论框架，开源可跑。

完整版 `Aria2ever` 学过赵赵所有的文字、读过的书、判断方式。
